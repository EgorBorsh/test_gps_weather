...
public class WeatherData {
    ...
    private static final String OPEN_WEATHER_MAP_API = "http://api.openweathermap.org/data/2.5/weather?q=%s&units=metric&lang=ru";
    ...
    public static JSONObject getJSONData (Context context, String city){
        try{
            ...
            connection.addRequestProperty("x-api-key", context.getString(R.string.open_weather_id));
